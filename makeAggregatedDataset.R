...
#' @return Creates a NcML document at the specified location.
#' @export
...
#' @details The use of NcML is not only intended for CDM file combination, and this function considers just a particular case.
...
makeAggregatedDataset <- function(source.dir, ncml.file, file.ext = "nc", aggr.dim = "time", pattern = NULL, recursive = FALSE, verbose = TRUE) {
...
# # Example 1. Simple uion of files (1 single file per variable)
# makeAggregatedDataset(source.dir="/home/juaco/.gvfs/SFTP for juaco on ui01.macc.unican.es/vols/seal/oceano/gmeteo/DATA/ECA/EOBS/Grid_0.25deg_reg/v9/data/", ncml.file="ignore/prueba.ncml", recursive=TRUE, pattern="rr|tn|tx")
# di <- dataInventory("ignore//prueba.ncml")
# str(di)
# # Example 2.
# makeAggregatedDataset(source.dir = "datasets/reanalysis/Iberia_NCEP/", ncml.file = "ignore/pruebaNCEP.ncml",aggr.dim = "level", verbose = TRUE, pattern = "700|850|SLP")
# di <- dataInventory("ignore/pruebaNCEP.ncml")
# str(di)
# # Example 3
# makeAggregatedDataset(source.dir = "/home/juaco/temp/NCEP/", ncml.file="ignore/pruebaJoinTime.ncml")
# di <- dataInventory("ignore/pruebaJoinTime.ncml")
# str(di)
# # Example 4
# makeAggregatedDataset(source.dir="/home/juaco/temp/aemetError/ncfiles/", ncml.file="ignore/otra_prueba.ncml")
# di <- dataInventory("ignore/otra_prueba.ncml")
# str(di)
# # Example 5
# makeAggregatedDataset("/home/juaco/.gvfs/SFTP for juaco on ui01.macc.unican.es/vols/seal/oceano/gmeteo/DATA/DMI/ERA40/KNMI/25km/DM/", ncml.file="ignore/pruebaDMI.ncml",pattern="hursmax|tas\\.")
# di <- dataInventory("ignore/pruebaDMI.ncml")
# # Casca
# # Example 6
# source.dir = "/home/juaco/.gvfs/SFTP for juaco on ui01.macc.unican.es/vols/seal/oceano/gmeteo/DATA/METEOLAB_PUBLIC/ObservationsData/WFDEI/daily/data"
# ncml.file = "ignore/pruebaWFDEI.ncml"
# file.ext = "nc"
# pattern = "fwi"
# recursive = TRUE
# makeAggregatedDataset(source.dir=source.dir, ncml.file=ncml.file, pattern=pattern, recursive=recursive)
# %TODO - check what happens for files containing several variables
# %TODO - function to create a new aggregation dimension (Exercise 3 in [http://www.unidata.ucar.edu/software/thredds/current/netcdf-java/ncml/v2.2/Aggregation.html])
# createAggrDim <- function(new.dim.name) {
#
# }
