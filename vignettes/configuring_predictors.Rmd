...
```{r,fig.cap='Precipitation observations used as predictand. Type `help("VALUE_Iberia_pr")` for further details.',message=FALSE}
...
out <- prepare_predictors(x = x,
                          y = y,
                          global.vars = c("air850", "slp"),
                          local.predictors = list(neigh.vars = "shum850",
                                                  n.neighs = 4,
                                                  neigh.fun = NULL)
)
``` 
